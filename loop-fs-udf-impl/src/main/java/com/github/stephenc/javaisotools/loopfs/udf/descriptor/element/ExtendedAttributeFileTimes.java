 ...
 */
public class ExtendedAttributeFileTimes extends ExtendedAttribute {
...
//	20 D_L File Times bytes
	...
	public Long fileTimeExistence;
	public byte[] fileTimes;

	public static final int MINIMUM_LENGTH = 12;

	public ExtendedAttributeFileTimes(byte[] bytes) throws InvalidDescriptor {
		super(bytes);
	...
	private void deserialize(byte[] bytes) throws InvalidDescriptor {
		...
		fileTimeExistence = UDFUtil.getUInt32(bytes, 16);
		// FIXME: loop timestamps
		fileTimes = UDFUtil.getBytes(bytes, 20, dataLength.intValue());
	}
