...
/**
 * The RR field. (RRIP specification section 4.1)
 */
public class RripFieldRR extends SuspField
{
	public RripFieldRR() {
	}

	public RripFieldRR(byte[] bytes, int bp) throws InvalidSuspField {
		this.deserialize(bytes, bp);
	}

	@Override
	public int getExpectedId() {
		return Constants.RR_FIELD_ID_RR;
	}
