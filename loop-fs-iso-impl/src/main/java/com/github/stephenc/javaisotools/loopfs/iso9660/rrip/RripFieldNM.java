...
/**
 * The NM field. (RRIP specification section 4.1)
 */
public class RripFieldNM extends SuspField
{
	private int flags;
	...
	public RripFieldNM(byte[] bytes, int bp) throws InvalidSuspField {
		this.deserialize(bytes, bp);
	}

	@Override
	public int getExpectedId() {
		return Constants.RR_FIELD_ID_NM;
	}
	...
	public void deserialize(byte[] block, int bp) throws InvalidSuspField {
		...
		this.nameContent = Util.getString(block, bp + 5, this.length - 5);
	}
