...
/**
 * The PL field. (RRIP specification section 4.1)
 */
public class RripFieldPL extends SuspField
{
	public RripFieldPL() {
	}

	public RripFieldPL(byte[] bytes, int bp) throws InvalidSuspField {
		this.deserialize(bytes, bp);
	}

	@Override
	public int getExpectedId() {
		return Constants.RR_FIELD_ID_PL;
	}
