...
/**
 * The RE field. (RRIP specification section 4.1)
 */
public class RripFieldRE extends SuspField
{
	public RripFieldRE() {
	}

	public RripFieldRE(byte[] bytes, int bp) throws InvalidSuspField {
		this.deserialize(bytes, bp);
	}

	@Override
	public int getExpectedId() {
		return Constants.RR_FIELD_ID_RE;
	}
