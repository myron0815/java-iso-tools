...
/**
 * The SF field. (RRIP specification section 4.1)
 */
public class RripFieldSF extends SuspField
{
	public RripFieldSF() {
	}

	public RripFieldSF(byte[] bytes, int bp) throws InvalidSuspField {
		this.deserialize(bytes, bp);
	}

	@Override
	public int getExpectedId() {
		return Constants.RR_FIELD_ID_SF;
	}
