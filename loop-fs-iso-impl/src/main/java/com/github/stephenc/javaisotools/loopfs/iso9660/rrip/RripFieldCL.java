...
/**
 * The CL field. (RRIP specification section 4.1)
 */
public class RripFieldCL extends SuspField
{
	public RripFieldCL() {
	}

	public RripFieldCL(byte[] bytes, int bp) throws InvalidSuspField {
		this.deserialize(bytes, bp);
	}

	@Override
	public int getExpectedId() {
		return Constants.RR_FIELD_ID_CL;
	}
