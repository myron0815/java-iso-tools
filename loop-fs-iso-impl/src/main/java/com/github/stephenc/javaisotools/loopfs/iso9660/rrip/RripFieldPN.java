...
/**
 * The PN field. (RRIP specification section 4.1)
 */
public class RripFieldPN extends SuspField
{
	public RripFieldPN() {
	}

	public RripFieldPN(byte[] bytes, int bp) throws InvalidSuspField {
		this.deserialize(bytes, bp);
	}

	@Override
	public int getExpectedId() {
		return Constants.RR_FIELD_ID_PN;
	}
